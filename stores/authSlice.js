...
// export const createAuthSlice = create()(
//   persist(
//     (set, get) => ({
//       user: null,
...
//           // /${get().user.id}
//         try {
//           const res = await axios.put(`http://ec2-54-147-13-74.compute-1.amazonaws.com/api/v1/delete/profile/${get().user.id}`, updatedData,{
//               headers:{
//                   'Authorization': `Bearer ${token}`
//               }
//           });
