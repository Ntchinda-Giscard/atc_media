...
interface PageSectionHeaderProps {
    ...
    hideSearch?: boolean;
    hideGridShow?: boolean;
    searchQuery?: string;
    onChangeSearch?: Dispatch<SetStateAction<string>>;
}

function PageSectionHeader({
    title, setShowGrid, showGrid, hideGridShow, actionButtonClick, actionButtonIcon, actionButtonText, hideActionButton = false, onChangeSearch, searchQuery, hideSearch
