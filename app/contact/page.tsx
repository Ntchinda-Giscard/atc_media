        ...
        <>
            <main className="min-h-svh min-w-full ">
                <div className="w-full text-center">
                    ...
                    <p className="font-medium mt-7 text-base px-10 mb-20">Besoin d’aide ? Une question ? Notre équipe est à votre disposition pour vous accompagner.📌 Réponse sous 24h ouvrées. </p>
                </div>
